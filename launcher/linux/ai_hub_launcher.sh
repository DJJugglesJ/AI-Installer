...
# AI Hub launcher status panel (deprecated)
# - Purpose: redirect legacy YAD status panel entrypoints to the Web Launcher.
...
echo "[!] The YAD-based status panel is deprecated. Redirecting to the Web Launcher..." >&2
